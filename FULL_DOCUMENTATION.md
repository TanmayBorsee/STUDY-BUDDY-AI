...
```bash
cat /home/tvborse96/.minikube/ca.crt | base64 -w 0; echo
cat /home/tvborse96/.minikube/profiles/minikube/client.crt | base64 -w 0; echo
cat /home/tvborse96/.minikube/profiles/minikube/client.key | base64 -w 0; echo
```
